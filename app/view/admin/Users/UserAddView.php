<div>
  ...
  <form action="http://localhost/php3d/?C=UserController&M=Add" method="post" enctype="multipart/form-data">
    <p>
      <label for="user">Usuario : </label><input type="text" name="user" id="user" placeholder="Usuario..." required />
    </p>
    <p>
    ...
    <p>
      <label for="apate">Apellido Paterno : </label><input type="text" name="apate" id="apate" placeholder="Apellido Paterno..." />
    </p>
    <p>
      <label for="amate">Apellido Materno : </label><input type="text" name="amate" id="amate" placeholder="Apellido Materno..." />
    </p>
    <p>
